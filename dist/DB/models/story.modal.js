...
const storySchema = new mongoose_1.default.Schema({
    createdBy: { type: mongoose_1.Types.ObjectId, ref: "User", required: true, index: true },
...
const StoryModel = mongoose_1.default.models.Story || mongoose_1.default.model("Story", storySchema);
